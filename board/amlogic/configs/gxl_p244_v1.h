    ...
    "storeargs="\
        ...
        "init_display="\
            ...
            "else "\
                "setenv reboot_mode_android ""normal"";"\
                "run storeargs;"\
                "osd open;osd clear;imgread pic logo bootup $loadaddr;bmp display $bootup_offset;bmp scale;vout output ${outputmode};dovi set;dovi pkg;vpp hdrpkt;"\
            "fi;fi;"\
            "\0"\
        "cmdline_keys="\
