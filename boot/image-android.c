...
{
	return !memcmp(ANDR_BOOT_MAGIC, boot_img, ANDR_BOOT_MAGIC_SIZE);
}

static void android_boot_image_v3_v4_get_data(const struct andr_boot_img_hdr_v3_v4 *hdr,
...
static void android_vendor_boot_image_v3_v4_get_data(const struct andr_vendor_boot_img_hdr_v3_v4
...
static void android_boot_image_v0_v1_v2_get_data(const struct andr_boot_img_hdr_v0_v1_v2 *hdr,
						 struct andr_image_data *data)
{
	ulong end;
			    ...
			    struct andr_image_data *data)
{
	...
	if (((struct andr_boot_img_hdr_v0_v1_v2 *)boot_hdr)->header_version > 2) {
		...
		android_vendor_boot_image_v3_v4_get_data(vendor_boot_hdr, data);
	} else {
